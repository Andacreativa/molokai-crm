...
const PILL_COLORS: Record<string, string> = {
  ...
  'Spagna': 'linear-gradient(160deg, rgba(255,130,130,0.97) 0%, rgba(239,68,68,1) 50%, rgba(180,28,28,1) 100%)',
  'Italia': 'linear-gradient(160deg, rgba(100,220,150,0.97) 0%, rgba(34,197,94,1) 50%, rgba(21,128,61,1) 100%)',
  'Altro':  'linear-gradient(160deg, rgba(130,145,165,0.97) 0%, rgba(100,116,139,1) 50%, rgba(51,65,85,1) 100%)',
}
...
const PILL_SHADOW: Record<string, string> = {
  ...
  'Spagna': '0 1px 0 0 rgba(255,200,200,0.6) inset, 0 -1px 0 0 rgba(140,0,0,0.3) inset, 0 3px 10px rgba(239,68,68,0.4)',
  'Italia': '0 1px 0 0 rgba(180,255,210,0.6) inset, 0 -1px 0 0 rgba(0,100,40,0.3) inset, 0 3px 10px rgba(34,197,94,0.4)',
  'Altro':  '0 1px 0 0 rgba(200,215,230,0.5) inset, 0 -1px 0 0 rgba(20,30,50,0.25) inset, 0 3px 10px rgba(100,116,139,0.3)',
}

const OPTIONS = [{ val: '', label: 'Tutte' }, ...AZIENDE.map(a => ({ val: a, label: a }))]

export default function FiltriBar({ anno, azienda, onAnno, onAzienda, showAzienda = true }: Props) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      {showAzienda && (
        <div ref={containerRef} className="relative flex gap-1 bg-gray-100/80 rounded-xl p-1">
          ...
          <div
            ...
            style={{
              ...
              transition: 'left 0.25s cubic-bezier(0.34,1.56,0.64,1), width 0.2s ease, background 0.2s ease, box-shadow 0.2s ease',
            }}
          />
