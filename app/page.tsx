        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow: '0 1px 0 0 rgba(255,180,220,0.15) inset, 0 8px 32px rgba(232,48,138,0.2)',
            }}
          >
            <Wallet size={52} color="#e8308a" />
          </div>
          <span className="text-white text-sm font-semibold tracking-wide">Finance</span>
        </Link>
        ...
        >
          <div
            ...
            style={{
              ...
              backdropFilter: 'blur(20px)',
              WebkitBackdropFilter: 'blur(20px)',
              boxShadow: '0 1px 0 0 rgba(255,120,100,0.15) inset, 0 8px 32px rgba(219,41,27,0.2)',
            }}
          >
            <TrendingUp size={52} color="#db291b" />
          </div>
          <span className="text-white text-sm font-semibold tracking-wide">Sales</span>
        </Link>
      </div>
